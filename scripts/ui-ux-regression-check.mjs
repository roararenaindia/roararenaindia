...
assert.match(home, /bookingUrl: 'https:\/\/docs\.google\.com\/forms\/d\/e\/1FAIpQLSfIJUScvxpf8q1qhtNElX-ZT9AwQkmlTjyZomIyejumO3PksA\/viewform\?usp=publish-editor'/, 'event hero must store the published Google Form registration URL')
