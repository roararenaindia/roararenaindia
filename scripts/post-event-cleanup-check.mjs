...
assert.doesNotMatch(liveHome, /isCompletedWimbledonPost|filter\(\(post\) => !isCompletedWimbledonPost\(post\)\)/, 'live home payload must keep Wimbledon posts in the public feed')
