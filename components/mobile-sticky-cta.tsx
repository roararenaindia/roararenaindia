...
export default function MobileStickyCtA() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 md:hidden bg-background border-t border-white/10 bg-opacity-97 backdrop-blur-sm" style={{ paddingBottom: 'max(0.75rem, env(safe-area-inset-bottom))' }}>
          ...
          <Link
            ...
            className={`flex-1 py-3 text-xs md:text-sm font-semibold rounded-2xl transition-all text-center ${
              idx === 0
                ...
                : 'bg-surface-elevated text-foreground border border-white/10 hover:border-primary/30'
            }`}
          >
            {btn.label}
          </Link>
