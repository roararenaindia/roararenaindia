      ...
      <section className="relative mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 grid gap-4 lg:grid-cols-[1fr_auto]">
          ...
          <div className="grid min-w-[280px] grid-cols-2 gap-3 rounded-[1.5rem] border border-border bg-card p-4">
            ...
            <StatusPill active={health?.instagramConfigured} label="Instagram" />
            <StatusPill active={health?.apiFootballConfigured} label="Matches" />
            <StatusPill active={health?.xConfigured} label="X" />
          </div>
        </div>
        ...
        <div className="mb-6 grid gap-3 md:grid-cols-3 xl:grid-cols-7">
          ...
          <button onClick={() => runAction('Instagram sync', '/api/sync/instagram')} className="rounded-[1.4rem] border border-border bg-card p-5 text-left transition hover:-translate-y-1 hover:border-primary/45">
            <Camera className="mb-4 h-6 w-6 text-primary" />
            <p className="font-display text-3xl uppercase leading-none">Sync IG</p>
            <p className="mt-2 text-xs leading-5 text-muted-foreground">Pull newest Instagram posts.</p>
          </button>
          <button onClick={() => runAction('X sync', '/api/sync/x')} className="rounded-[1.4rem] border border-border bg-card p-5 text-left transition hover:-translate-y-1 hover:border-primary/45">
            <Activity className="mb-4 h-6 w-6 text-primary" />
            <p className="font-display text-3xl uppercase leading-none">Sync X</p>
            <p className="mt-2 text-xs leading-5 text-muted-foreground">Pull latest X posts.</p>
          </button>
          ...
          <button onClick={() => runAction('Full sync', '/api/sync/all')} className="rounded-[1.4rem] border border-border bg-card p-5 text-left transition hover:-translate-y-1 hover:border-primary/45">
            <Send className="mb-4 h-6 w-6 text-primary" />
            <p className="font-display text-3xl uppercase leading-none">Sync All</p>
            <p className="mt-2 text-xs leading-5 text-muted-foreground">Run social, matches, and curation.</p>
          </button>
