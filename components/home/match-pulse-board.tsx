...
import { CalendarDays, CheckCircle2, MapPin, Radio } from '@/components/ui/icon-set'
    ...
    <section id="live" className="relative overflow-hidden bg-background py-16 sm:py-20 lg:py-28">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 flex items-start gap-3 rounded-[1.6rem] border border-border bg-card p-5 text-sm leading-6 text-muted-foreground">
          ...
          <p>
            The live board reads Supabase first. Cron refreshes match data every 2 hours, then auto-curates the hero so the site never gets stuck on an old story. Country crests resolve from a shared logo map, so they stay correct across fixtures, results, and the featured match.
          </p>
        </div>
      </div>
    </section>
