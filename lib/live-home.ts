import { getHomePayload, type ArenaMatch } from '@/lib/arena-live-data'
import type { ArenaPost } from '@/lib/site-data'
import { descriptionFromCaption, inferLeagueLogo, inferTeams, titleFromCaption } from '@/lib/content-inference'
