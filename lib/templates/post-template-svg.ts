...
import type { InstagramTemplateInput, TemplateFixture, TemplateTeam } from '@/lib/templates/post-template-types'
import { defaultFixturesTemplate, defaultInstagramTemplate, defaultPreviewTemplate } from '@/lib/templates/post-template-types'
